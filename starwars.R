...
#create height in inch and round up to 1 decimal point
  mutate(height_in = round(height * 0.3937, 1))%>%
...
#select the target variables
  select(sw_wrangled, first_name, last_name, initials, height_in, height_cm, mass, hair, gender, species, homeworld, brown_hair)
