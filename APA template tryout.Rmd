...
```
<!--Assignment 17-->
The study recruited `r nrow(A_and_PS)` participants. The mean age is `r mean(ages$age)`, `r sd(ages$age)`.
...
ggplot(data = Age_and_Possible_Selves_9_6_19, aes(x = Age_and_Possible_Selves_9_6_19$swl_avg, y = Age_and_Possible_Selves_9_6_19$scc_avg, color = age_group)) +
  geom_smooth(method = lm) +
  geom_point() +
