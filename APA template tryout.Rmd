...
---
<!--Assignment 17-->
The study recruited `r nrow(Age_and_Possible_Selves_9_6_19)` participants. The mean age is `r mean(age)`, `r sd(age)` and `r print(frq_female)` female.
...
#reframe(mean_age = mean(age, na.rm = TRUE)) %>%
 # reframe(median_age = median(age,na.rm = TRUE)) %>%
  ...
  ) #I cannot see the result table, I don't know how to let it show
...
cor_scc_swl <- cor(Age_and_Possible_Selves_9_6_19$scc_avg, Age_and_Possible_Selves_9_6_19$swl_avg)
print(cor_scc_swl)
#Show in New Window
